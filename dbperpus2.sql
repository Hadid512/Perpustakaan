...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2024 at 05:25 PM
...
('PRW001', 'Ahmad Haedra', 'Pria', 'Malang', 'PRW001.jpg'),
...
CREATE TABLE `tbtransaksi` (
  ...
  `idanggota` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `idbuku` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
